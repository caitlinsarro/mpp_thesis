...
dict_descrip <- dictionary(list(participation_keystems = c("particip", "propos","relev", "associ","compet","represent","stakehold", "collabor","consensus","decis", "facilit", "aspect","form", "activ", "matter","indirect","affair","vote", "extend","engag","stakeholder engag", "multi-stakehold", "cooper", "divers inclus","participatori mechan","vulner popul", "cultur heritag", "indigen", "youth indigen", "reduc inequ",  "build trust",  "stakehold priorit", "civil societi",  "social inclus", "cultur divers", "discuss forum","convers", "interact platform", "live heritag", "interdisciplinari issu", "interdisciplinari", "delib", "delib process", "citizen","citizen engag", "repres","deliber", "panel", "institution",  "juri", "trust", "participatori","participatori process", "involv","communiti", "societi", "ballot","dialogu", "discuss", "inclus","youth", "assembl", "confer","facilit method","communic","trainer", "confid","emot",  "listen","reflect", "relationship", "rapport", "deliveri","negoti", "techniqu","deleg", "behaviour","behavior","creativ", "frontlin", "indigen", "union", "disabl","elder", "marginla","marginlais"  
                             ...
                             policy_coh_keystems = c("coher", "extent", "coher structur", "foster", "coordin", "implement", "interministeri", "systemat", "mutual"  ,"reinforc" ,"intern cooper",  "synergi"    , "integr", "overcom",             "silo",                 "unintend consequ" ,    "diverg", "interrel" , "trade off" ,           "feedback loop" ,       "institut chang", "strategi" ,            "horizont framework" , "vertic" ,              "align"   , "balanc"  ,     "intersector interact", "intersector",        "conceptu" , "coher polici plan",           "link"  , "system think",              "operationalis", "operation" ,           "prioriti"  , "approach across",  "integr coherent plan",        "subnat"  ,             "aspir"  ,  "mechan"    ,           "partnership",          "complement",           "connect",  "contradictori",        "leverag point" ,      "integr plan" ,         "cross depart",   "strateg polici",          "comprehens system"     ,          "comprehens",           "consist", "duplic" ,              "exist"   ,             "interlink",            "lever" ,  "relat" ,          "commit", "reiter",                    "contradict",           "reaffirm" , "shift" ,               "symbiosi" ,    "transform polici pathway",        "reciproc",             "solidar"  , "cooper"    ,           "polici coher" ,        "align polici decis",   "polici sequenc", "polici align" ,        "interconnect" ,        "increas coher",        "across govern depart", "institut structur" ,   "common goal" ,         "complex issu" ,        "govern depart", "transgovernance", "integr plan"),
                               ...
                               reflex_adpt_keystems = c("reflex", "monitor","reform","regulatori","instrument", "trajectori","perform","transdisciplinari", "process improv","self monitor", "strateg plan","impact assess","organiz reform","adapt", "evidence-bas", "self-awar", "develop strategi", "long term", "assess","data analysi","big data","leverag big data","web data", "data collect","data applic","data design", "understand data","data inform","measur","account","system chang","applic tool assess","assess valu add","structur chang","structur shift" , "polici instrument","inform manag","python","help compani", "scienc base", "program polici","metric","cycl",  "strategic plan" ,"human resourc","guidelin",  "integr","daily practic","public servic", "long term",  "development plan", "domest","evidence bas", "report", "progress",  "evalu", "statist","indic", "impact", "evid",  "reflect","result","analysi","collect") 
   ))
