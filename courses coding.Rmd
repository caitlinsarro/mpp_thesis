...
final_coded_dataset <- read_csv("data/final/final_coded_dataset_.csv")
```


```{r}
#reattach author list
...
all_courses_coded_long$category[all_courses_coded_long$category == "democratic institutions"] <-"Democratic Institutions"
all_courses_coded_long$category[all_courses_coded_long$category == "participation"] <-"Participation"
all_courses_coded_long$category[all_courses_coded_long$category == "policy coherence"] <-"Policy Coherence"
all_courses_coded_long$category[all_courses_coded_long$category == "reflexivity and adaptation"] <-"Reflexivity & Adaptation"

all_courses_coded_long$category <- factor(all_courses_coded_long$category, levels = c("Participation", "Policy Coherence", "Democratic Institutions", "Reflexivity & Adaptation"))
...
freq_table <- table(all_courses_coded_long$category, all_courses_coded_long$au_category)
