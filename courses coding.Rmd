...
dict_descrip <- dictionary(list(participation_keystems = c("particip", "propos", "assess", "relev", "associ", "compet", "represent", "stakehold", "collabor", "consensus", "decis", "facilit", "aspect", "form", "concept", "activ", "matter", "indirect", "affair", "vote", "extend", "engag", "participation", "stakeholders", "multi-stakeholders","cooperation", "collaboration", "diversity and inclusion", "vulnerable populations", "cultural heritage", "youth and indigenous people", "reduce inequalities", "build trust", "stakeholders prioritize", "social inclusion", "cultural diversity", "discussion forum", "conversations", "interactive platform", "living heritage"),
                             policy_coh_keystems = c("coher", "extent", "structur", "foster", "coordin", "implement", "interministeri", "systemat", "mutual", "reinforc", "synergi", "integr", "coordination", "overcom", "silo", "unintended consequences", "diverg", "interrel", "trade off", "feedback loop", "policy coherence","coherence", "align policy decisions", "policy sequence", "policy sequencing", "policy alignment", "interconnected", "increase coherence", "across government departments", "institutional structures", "common goals", "complex issues", "government departments"),
                             
                               democratic_keystems = c("elector", "media", "freedom", "civil", "liberti", "rule", "law", "govern", "transpar", "percept", "credibl", "express", "fair", "legislatur", "check", "balanc", "altern", "respect", "independ", "judiciari", "legitim", "liber", "democraci", "voter", "franchis", "pluralist", "competit", "equal", "autocraci", "regim", "represent", "peace", "civil liberties", "democratic institutions", "negotiation skills", "ethical leadership", "contract negotiations", "government negotiators", "transaction cost", "human rights", "transaction cost", "free elections", "political philosopher", "political polarization", "populism"),
                             
                               reflex_adpt_keystems = c("reflex", "monitor", "reform", "regulatori", "instrument", "trajectori", "perform", "transdisciplinari", "process improvement", "reflexivity", "self-monitoring", "strategic planning", "regulatory", "impact assessments", "impact assessment", "organizational reform", "adaptability", "evidence-based", "self-awareness", "performance", "development strategies", "development strategy", "long term", "assessment", "data", "measurement", "accountability", "systemic changes", "structural changes", "structural shifts", "policy instrument", "policy instruments"))
