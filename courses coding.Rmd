...
dict_descrip <- dictionary(list(participation_keystems = c("particip", "propos", "assess", "relev", "associ", "compet", "represent", "stakehold", "collabor", "consensus", "decis", "facilit", "aspect", "form", "concept", "activ", "matter", "indirect", "affair", "vote", "extend", "engag", "particip", "stakehold", "multi-stakehold", "cooper", "collabor", "divers inclus", "vulner popul", "cultur heritag", "youth indigen peopl", "reduc inequ", "build trust", "stakehold priorit", "social inclus", "cultur divers", "discuss forum", "convers", "interact platform", "live heritag", "interdisciplinari issu", "interdisciplinari", "social inclus"),
                             policy_coh_keystems = c("coher", "extent", "structur", "foster", "coordin", "implement", "interministeri", "systemat", "mutual", "reinforc", "synergi", "integr", "coordin", "overcom", "silo", "unintend consequ", "diverg", "interrel", "trade off", "feedback loop", "polici coher", "coher", "align polici decis", "polici sequenc", "polici sequenc", "polici align", "interconnect", "increas coher", "across govern depart", "institut structur", "common goal", "complex issu", "govern depart"),
                             
                               democratic_keystems = c("elector", "media", "freedom", "civil", "liberti", "rule", "law", "govern", "transpar", "percept", "credibl", "express", "fair", "legislatur", "check", "balanc", "altern", "respect", "independ", "judiciari", "legitim", "liber", "democraci", "voter", "franchis", "pluralist", "competit", "equal", "autocraci", "regim", "repres", "peac", "civil liberti", "democrat institut", "negoti skill", "ethic leadership", "contract negoti", "govern negoti", "transact cost", "human right", "transact cost", "free elect", "polit philosoph", "polit polar", "popul"),
                             
                               reflex_adpt_keystems = c("reflex", "monitor", "reform", "regulatori", "instrument", "trajectori", "perform", "transdisciplinari", "process improv", "reflex", "self-monitor", "strateg plan", "regulatori", "impact assess", "impact assess", "organiz reform", "adapt", "evidence-bas", "self-awar", "perform", "develop strategi", "develop strategi", "long term", "assess", "data", "measur", "account", "system chang", "structur chang", "structur shift", "polici instrument", "inform manag", "system think", "python program", "help compani", "scienc base", "program polici")))
