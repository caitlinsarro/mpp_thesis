...
combined <- rbind(keywords_cour, keywords_unsdglearn_silos, keywords_unsdglearn, keywords_sdgacademy, keywords_unpan)
...
ggplot(au_matrix, aes(fill=Var2, y=Freq, x=Var1)) +
  ...
  geom_line(data= au_matrix_un, aes(x=Var1, y=Freq, group = Var1)) +
  theme_minimal() 
