...
descrip_comb_test <- descrip_comb %>% select( -id)

colnames(descrip_comb_test)[apply(descrip_comb_test,1,which.max)]
...
#this is it
descrip_comb %>% mutate(max.col = colnames(descrip_comb_mini)[max.col(descrip_comb_mini)])
