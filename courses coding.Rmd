...
democratic_institutions_ <- read_csv("data/dictionary/glass newig/democratic institutions .csv")
...
policy_coh_keystems <- as.list(tidy_participation$word)


policy_coh_keystems <- as.list(tidy_participation)
