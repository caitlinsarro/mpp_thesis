...
ngo <-
  c('501|nonprofit|non-profit|non-governmental|nongovernmental|Non-governmental organization|Non-governmental|NGO|ngo')
df_ngo <- data.frame(authors_list_A$authors, ngo = 0)
df_ngo[grep(ngo, df_ngo$authors, value = F), "ngo"] <- 1
colnames(df_ngo)[1] <- "authors"
...
authors_list_A_comb <- left_join(authors_list_A_comb,df, by = "authors") 
authors_list_A_comb
authors_list_A_comb <- left_join(authors_list_A_comb,df_agent, by = "authors")
authors_list_A_comb <- left_join(authors_list_A_comb,df_ngo, by = "authors")
