...
authors_list_A_comb <- merge(authors_list_A, df, by.x = "authors", all = TRUE)
authors_list_A_comb <- merge(authors_list_A, df_agent, by.x = "authors", by.y = "authors_list_A.authors", all = TRUE)

authors_list_A_comb$category[authors_list_A$un_programs=="1"] <- "un program"
authors_list_A_comb$category[authors_list_A$un_specialized_agencies=="1"] <- "un specialized agency"
