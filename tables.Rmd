...
```{r}
#table 6
tb6_part <- c("16.8%", "20.0%", "26.1%", "12.6%", "19.6%", "37.1%")
tb6_pol <- c("14.0%", "15.2%", "17.1%", "11.3%", "5.6%", "13.8%")
tb6_dem <- c("26.7%", "32.9%", "42.4%", "8.3%", "36.5%", "26.4%")
tb6_ref <- c("42.5%", "31.9%", "14.4%", "67.8%", "38.3%", "22.7%")
...
table6 %>%
  kbl(caption = "Table 6. Sustainable Governance Capacities for trainings by UN Author Groups") %>%
   column_spec(column = 1, width = ".35in")  %>%
   column_spec(column = 2, width = ".35in") %>%
   column_spec(column = 3, width = ".35in") %>%
   column_spec(column = 4, width = ".55in") %>%
