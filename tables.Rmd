...
freq_table %>%
  kbl(caption = "Table 3. Authors of Training Courses (Weighted) by Goverance Category", col.names=c("Sustainable Governance Category","Civil Society","Government","Private University","Public University","Research & Business","UN")) %>%
  kable_classic(full_width = F, html_font = "Open Sans") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"))
