...
soft_coded_long <- read_csv("exports/full_code.csv")
...
soft_code_split <- initial_split(data = soft_coded_long, strata = major_categ, prop = .8)
...
soft_code_folds <- vfold_cv(data = soft_code_train, strata = major_categ, v = 8)
soft_code_folds
