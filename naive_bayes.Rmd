...
courses_folds <- vfold_cv(data = courses_train, strata = major_categ, v = 10, repeats = 3)
courses_folds
...
nb_cvs_predictions %>%
  ...
  labs(
    color = NULL,
    title = "Performance of the Sustainable Governance \nCapacities Classification Model for \nSDG Trainings",
