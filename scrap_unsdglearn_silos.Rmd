...
unsdglearn_silos <- read_html(page_source[[1]])
...
```{r}
parsed_nodes <- html_nodes(unsdglearn_silos, 
...
parsed_nodes2 <- html_nodes(unsdglearn_silos, 
                           xpath = '//*[contains(concat( " ", @class, " " ), concat( " ", "card-institutions", " " ))] | //*[contains(concat( " ", @class, " " ), concat( " ", "tippy", " " ))]')
...
weblink <- html_nodes(unsdglearn_silos, 
