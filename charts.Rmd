...
packages = c('tidyverse', 'tidytext', 'dplyr', 'ggplot2','plyr','gridExtra')
...
p1_u <- ggplot(weighted_un, mapping=aes(x=Var2, 
  ...
  labs(
    title = "% Change of UN collaborative authorship compared to the UN solo-authorship",
    subtitle = "Distribution of Governance Category",
...
p2_g <- ggplot(weighted_gov, mapping=aes(x=Var2, 
  ...
  ylim(-0.40, 0.20)+
           scale_y_continuous(labels = scales::percent) +
  labs(
    title = "% Change of Government Authorship compared to the UN",
    subtitle = "Distribution of Governance Category",
    x = "Sustainable Governance Capacities",
    y = NULL
  )
...
p3_u <- ggplot(df_long, aes(fill=university, y=perchang, x=Var2)) + 
    geom_bar(position="stack", stat="identity")+
           scale_y_continuous(labels = scales::percent) +
  labs(
    title = "% Change of University Authorship \ncompared to the UN",
    subtitle = "Distribution of Governance Category",
    x = "Sustainable Governance Capacities",
    y = "Number of training courses", legend=FALSE
  ) + theme(legend.position = "none")
p3_u
```
...
p4_c <- ggplot(df_long, aes(fill=org, y=perchang, x=Var2)) + 
    geom_bar(position="stack", stat="identity") +
           scale_y_continuous(labels = scales::percent)+
  labs(
    title = "% Change of Civil Society, Research & Business Authorship compared to the UN",
    subtitle = "Distribution of Governance Category",
    x = "Sustainable Governance Capacities",
    y = NULL
  ) + theme(legend.position = "none")
